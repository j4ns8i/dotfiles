local function set_highlights()
  ...
  c.hi('CmpItemKindModule',        { ctermfg = c.darkblue })
  c.hi('CmpItemKindField',         { ctermfg = c.darkblue })
  ...
  c.hi('CmpItemKindVariable',      { ctermfg = c.darkcyan })
