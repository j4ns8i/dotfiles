    ...
    lib.mkIf cfg.enable {
      ...
      home.file = {
        ".config/alacritty/alacritty.toml".source =
          config.lib.file.mkOutOfStoreSymlink "${config.j4ns8i.hmDir}/config/alacritty/alacritty.toml";
        ".config/alacritty/colors.toml".source =
          config.lib.file.mkOutOfStoreSymlink "${config.j4ns8i.hmDir}/config/alacritty/colors.toml";
        ".config/alacritty/os.toml".source =
          config.lib.file.mkOutOfStoreSymlink "${config.j4ns8i.hmDir}/config/alacritty/${osToml}";
